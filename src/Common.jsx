...
const Common =(props)=>{
  return(
    ...
    <div className="container-fluid nav bg">
      ...
      <div className="row">
        <div className="col-10 mx-auto">
          <div className="col-md-6 pt-5 pt-lg order-2 order-lg-1 d-flex jutify-content-center flex-column">
            <h1>{props.name}<strong className="brand-name">Us</strong></h1>
            <h2 className="my-3">
              We are the team of talented developers for making websites
            </h2>
            <div className="mt-3">
